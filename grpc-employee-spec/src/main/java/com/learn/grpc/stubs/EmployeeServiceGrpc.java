...
public final class EmployeeServiceGrpc {
  ...
  public static final String SERVICE_NAME = "src.main.resources.EmployeeService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.learn.grpc.stubs.EmployeeRequest,
      com.learn.grpc.stubs.EmployeeResponse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.learn.grpc.stubs.EmployeeRequest.class,
      responseType = com.learn.grpc.stubs.EmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.learn.grpc.stubs.EmployeeRequest,
      com.learn.grpc.stubs.EmployeeResponse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.learn.grpc.stubs.EmployeeRequest, com.learn.grpc.stubs.EmployeeResponse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod =
              io.grpc.MethodDescriptor.<com.learn.grpc.stubs.EmployeeRequest, com.learn.grpc.stubs.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.learn.grpc.stubs.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.learn.grpc.stubs.EmployeeResponse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.learn.grpc.stubs.EmployeeRequest request,
        io.grpc.stub.StreamObserver<com.learn.grpc.stubs.EmployeeResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.learn.grpc.stubs.EmployeeRequest,
                com.learn.grpc.stubs.EmployeeResponse>(
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.learn.grpc.stubs.EmployeeResponse getEmployee(com.learn.grpc.stubs.EmployeeRequest request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.learn.grpc.stubs.EmployeeResponse> getEmployee(
        com.learn.grpc.stubs.EmployeeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.learn.grpc.stubs.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<com.learn.grpc.stubs.EmployeeResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.learn.grpc.stubs.EmployeeServiceOuterClass.getDescriptor();
    }
